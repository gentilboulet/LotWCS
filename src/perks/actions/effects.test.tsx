...
describe('Testing effect creators', () => {
  it('should create a combat statistic effect', () => {
  ...
  it('should create a conditional text effect', () => {
    const lipsum = [
  ...
  it('should create a single line conditional text effect', () => {
  ...
  it('should not create a conditional text effect with an empty text', () => {
    expect( () => effects.conditionalText([]) ).toThrow();
    expect( () => effects.conditionalOnelineText('') ).toThrow();
  });

  it('should create an increase base chi for threshold effect', () => {
