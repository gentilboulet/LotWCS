...
import * as actions from 'state/actions/perks/bonuses';
...
describe('Testing applyBonuses', () => {
  ...
  it('should receive a BONUS_SPECIALITY', () => {
    ...
    expect( initialState.skills[testSkill].specialities.find(s => s===testSpeciality) ).toBeFalsy();
    expect( state.skills[testSkill].specialities.find(s => s===testSpeciality) ).toBeTruthy();
  });
