...
export const extraordinarywarriortechniques: IDataLoresheet = {
  ...
  options: [
    {
      ...
      type: "Flood",
      description:
        "Controlling Inner Force. Whether through pressure points, cruel cuts, or a deeper understanding of Wu Wei, the Warrior breaks the equilibrium of their opponent. When you achieve a critical success on a Disorient Marvel, you can Flood a die from your River to increase the penalty to -10",
      repeatable: false,
      prerequisites: [],
      perks: []
    },
    ...
    },
    {
      ...
      cost: 3,
      description:
        "Mirror Reflection Technique. You not only excel at reading the intricacies of your opponent’s style, but spend long hours training to copy it, unconsciously modeling your Chi to match their movements and shifting your own muscle tension to mimic theirs. Using the conflict itself as your training ground, you assume the hidden strengths of your enemy. After witnessing an opponent in combat and Detecting their chosen Combat Condition with the usual Tactics roll, you can Flood two dice from your River to instantly assume their approach and the associated Combat Condition.",
      repeatable: false,
      prerequisites: [],
      perks: []
    },
    {
      ...
      cost: 5,
      description:
        "Mirror Reflection Technique. There are whispers of an ultimate form of this technique that allows a Warrior to flow through forms to instinctively assume a superior tactic in response to his enemy. For every action, there is an appropriate reaction, and these legendary warriors have internalized the forms of battle. For an additional 5 Destiny, you learn the ultimate form of this technique: instead of copying your opponent’s form, you assume an approach that controls his! You describe the generalities of the approach, and the Sage determines the details.",
      repeatable: false,
    ...
    },
    {
      ...
      cost: 3,
      description:
        "Stance-Breaking Force technique. Having internalized the lessons of Five-Element combat theory and the tactical Classics, you easily wield the strengths of your Approach. Increase the bonus to Tactics rolls against an opponent’s approach that your approach Controls to +10.",
      repeatable: false,
      prerequisites: [],
      perks: []
    },
    {
      ...
      cost: 2,
      description:
        "Ten-Direction Movement Approach. Trap the foot. Close the gate. Block the way. Prevent your opponent from moving as they want, and remove any obstacles to your own path. Mastery of the field is the first step to victory. When you achieve a critical success on a Shaping Marvel, you can Flood to add +5 to the final result per die flooded.",
      repeatable: false,
      perks: [],
      prerequisites: []
    },
    {
      ...
      cost: 5,
      description:
        "Unassailable Battle Saint Technique. You are an enlightened warrior, having reached the deeper secrets of the Five-Element Approach to battle. You can spend 1 Joss when you roll a Critical Success to create a Combat Condition for yourself to make { it } a Major Condition",
      repeatable: false,
      prerequisites: [],
      perks: []
    }
