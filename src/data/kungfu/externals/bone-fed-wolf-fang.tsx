  ...
  techniques: new Array(
      {
        ...
        effect: effects.conditionalOnelineText("The difficulty to recover from Disrupt or Disorient Marvels you have imposed is increased by 10."),
        uid:"Circling Pack",
      },
      {
        ...
        effect: effects.conditionalOnelineText("This style’s Block and Dodge bonuses increase to +10 against any Disoriented or Disrupted target"),
      ...
      },
      {
        ...
        effect: effects.conditionalOnelineText("You may Flood 1 die from the River while you make an attack. If you do, the strike also creates a Disorient or Disrupt condition if it hits."),
      ...
      },
      {
        ...
        effect: effects.conditionalOnelineText("This style’s Strike bonus increases to +10 against any Disoriented or Disrupted target."),
      ...
      },
      {
        ...
        effect: effects.conditionalOnelineText("This style’s Damage bonus increases to +15 against any Disoriented or Disrupted target."),
